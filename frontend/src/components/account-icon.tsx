...
import { Building2, PiggyBank, CreditCard, TrendingUp, Wallet, Banknote } from 'lucide-react'
...
> = {
  ...
  loan:        { icon: Banknote,    color: 'text-rose-600',    bg: 'bg-rose-100',    label: 'accounts.typeLoan' },
